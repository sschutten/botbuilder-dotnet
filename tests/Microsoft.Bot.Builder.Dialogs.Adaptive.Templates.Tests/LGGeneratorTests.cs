...
namespace Microsoft.Bot.Builder.AI.LanguageGeneration.Tests
{
    public class LGGeneratorTests
    {
        ...
        public async Task TestMultiLangImport()
        {
            ...
            var generator = new TemplateEngineLanguageGenerator(resourceExplorer.GetResource("a.en-US.lg"), lgResourceGroup);
            ...
            generator = new TemplateEngineLanguageGenerator(resourceExplorer.GetResource("a.lg"), lgResourceGroup);
